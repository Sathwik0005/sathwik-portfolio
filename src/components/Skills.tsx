    ...
    },
    {
        ...
        skills: [
            ...
            },
            {
                name: "Node.js",
                icon: (
                    <svg viewBox="0 0 32 32" className="w-5 h-5"><path d="M16 2.9l-12 6.9v13.8L16 29.6l12-6.9V9.8L16 2.9z" fill="#339933"/><path d="M16 13.5c-.6 0-1 .4-1 1v4c0 .6.4 1 1 1s1-.4 1-1v-4c0-.6-.4-1-1-1zm-4 1.5c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z" fill="white"/></svg>
                ),
            },
            {
                name: "Express.js",
                icon: (
                    <svg viewBox="0 0 32 32" className="w-5 h-5"><rect width="32" height="32" rx="4" fill="#1a1a1a"/><text x="4" y="20" fontSize="9" fontWeight="bold" fill="white" fontFamily="monospace">express</text></svg>
                ),
            },
            {
                name: "Django",
